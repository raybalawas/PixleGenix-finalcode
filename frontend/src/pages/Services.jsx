...
// Combined service list with full data
const serviceData = [
  {
    title: 'Mobile App Development',
    description: 'We build native and cross-platform mobile applications with seamless performance.',
    ...
    packages: [
      {
        ...
        priceUSD: '$450',
        priceEUR: '€420',
        features: ['Android/iOS basic version', 'UI Design Included', 'Basic API integration'],
      },
      {
        name: 'Business',
        priceINR: '₹85,000',
        priceUSD: '$999',
        priceEUR: '€950',
        features: ['Cross-platform support', 'Backend API included', 'Push Notifications'],
      },
      {
        name: 'Enterprise',
        priceINR: '₹2,00,000+',
        priceUSD: '$2500+',
        priceEUR: '€2400+',
        features: ['Full enterprise suite', 'DevOps & CI/CD pipeline', '24/7 Support & Maintenance'],
      },
    ],
  ...
  },
  {
    ...
    description: 'Enterprise-grade software solutions for automation, CRM, ERP, and more.',
    icon: <FaCode className="text-indigo-600 text-4xl" />,
    image: "https://images.unsplash.com/photo-1581091870622-2c7b9a9dc0c2?auto=format&fit=crop&w=800&q=60",
    packages: [
      {
        name: 'Starter',
        priceINR: '₹50,000',
        priceUSD: '$600',
        priceEUR: '€550',
        features: ['Basic automation tool', 'Local database setup', '2-month support'],
      },
      {
        name: 'Business',
        priceINR: '₹1,00,000',
        priceUSD: '$1200',
        priceEUR: '€1150',
        features: ['CRM/ERP integration', 'Cloud support', 'Extended reporting'],
      },
      {
        name: 'Enterprise',
        priceINR: '₹3,00,000+',
        priceUSD: '$3500+',
        priceEUR: '€3300+',
        features: ['Custom solution', 'Advanced security', 'Dedicated support & maintenance'],
      },
    ],
  ...
  },
  {
    ...
    description: 'Modern websites with React, Node, and scalable backend solutions.',
    ...
    packages: [
      ...
      },
      {
        ...
        priceUSD: '$1800+',
        priceEUR: '€1700+',
        features: ['Full-stack web app', 'Cloud hosting', 'API & DB integration'],
      },
    ],
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1615911181804-dc9d6c6fe3ef?auto=format&fit=crop&w=800&q=60",
    packages: [
      {
        name: 'Starter',
        priceINR: '₹60,000',
      ...
      },
      {
        ...
        priceUSD: '$4800+',
        priceEUR: '€4600+',
        features: ['AR/VR support', 'Console deployment', 'Post-launch updates'],
      },
    ],
  ...
  },
  {
    ...
    description: 'SEO, PPC, Social Media, and content marketing strategies that convert.',
    ...
    packages: [
      ...
      },
      {
        ...
        priceUSD: '$1300+',
        priceEUR: '€1250+',
        features: ['Full funnel strategy', 'Email marketing', '24/7 Analytics dashboard'],
      },
    ],
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1566241440091-ec10de8db2e1?auto=format&fit=crop&w=800&q=60",
    packages: [
      {
        name: 'Starter',
        priceINR: '₹45,000',
      ...
      },
      {
        ...
        priceUSD: '$1200',
        priceEUR: '€1100',
        features: ['Multiple user roles', 'Real-time tracking', 'Payment gateway'],
      },
      {
        name: 'Enterprise',
        priceINR: '₹2,50,000+',
  ...
  },
  {
    ...
    description: 'Chatbots, predictive analytics, NLP, and ML-based applications.',
    icon: <FaRobot className="text-indigo-600 text-4xl" />,
    image: "https://images.unsplash.com/photo-1581091012184-5c1f75de0e4e?auto=format&fit=crop&w=800&q=60",
    packages: [
      {
        name: 'Starter',
        priceINR: '₹70,000',
      ...
      },
      {
        ...
        priceUSD: '$1800',
        priceEUR: '€1700',
        features: ['Predictive analytics', 'AI recommendations', 'Speech recognition'],
      },
      {
        name: 'Enterprise',
        priceINR: '₹3,50,000+',
        priceUSD: '$4200+',
        priceEUR: '€4000+',
        features: ['NLP engine', 'Real-time ML pipelines', 'Enterprise analytics suite'],
      },
    ],
  ...
  },
  {
    ...
    description: 'Custom eCommerce stores with secure payment, cart, and admin panel.',
    icon: <FaShoppingCart className="text-indigo-600 text-4xl" />,
    image: "https://images.unsplash.com/photo-1542834369-f10ebf06d3cb?auto=format&fit=crop&w=800&q=60",
    packages: [
      {
        name: 'Starter',
        priceINR: '₹30,000',
      ...
      },
      {
        ...
        priceUSD: '$2400+',
        priceEUR: '€2300+',
        features: ['Multi-vendor system', 'Inventory automation', 'Advanced analytics'],
      },
    ],
        ...
        {selectedService.title}
              ...
              <div className="p-6">
                ...
                {selectedService.packages && (
                  <>
                    <h4 className="text-xl font-semibold text-gray-800 mb-4">Packages</h4>
                    <div className="grid md:grid-cols-3 gap-6">
                      {selectedService.packages.map((pkg, i) => (
                        ...
                        >
                          <h5 className="text-lg font-semibold text-indigo-700 mb-1">{pkg.name}</h5>
                          <div className="text-sm text-gray-600 mb-3 space-y-1">
                            <p><strong>INR:</strong> {pkg.priceINR}</p>
                            <p><strong>USD:</strong> {pkg.priceUSD}</p>
                            <p><strong>EUR:</strong> {pkg.priceEUR}</p>
                          </div>
