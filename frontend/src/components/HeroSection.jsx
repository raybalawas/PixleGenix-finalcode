    ...
    <section className="relative h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-white text-center px-6 max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight drop-shadow-md">
          Empowering Ideas with <span className="text-indigo-400">Technology</span>
        </h1>
        <p className="mt-6 text-lg md:text-xl text-gray-100 max-w-2xl mx-auto">
          At <strong className="text-indigo-300">PixelGenix</strong>, we craft cutting-edge web, mobile, and AI-powered software that helps businesses transform and scale globally.
        </p>
